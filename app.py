...
def draw_table(times, time_map):
    ...
    for row_idx in range(2):
        ...
        for t in times:
            ...
            html += f"<td style='border: 1px solid #555; height: 35px; width: 50px; vertical-align: top; padding: 2px;'>{content}</td>"
        html += "</tr>"
    html += "</table>"
