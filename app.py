...
# Kiểm tra nếu người dùng đã đăng nhập thành công để hiển thị Sidebar và Nội dung
if st.session_state.user is not None:
    ...
    # Cấu hình bộ nạp và chọn chế độ trong Sidebar
    with st.sidebar:
    ...
    if uploaded_files:
        ...
        # Hiển thị danh sách các bài hát dạng nút bấm trong Sidebar (hoặc Main tùy chọn của cậu)
        # Ở đây đặt ngay dưới uploader/radio để người dùng dễ thao tác lựa chọn bài hát
        with st.sidebar:
        ...
        # Đọc dữ liệu bài hát hiện tại
        current_selected_file.seek(0)
        data = json.load(current_selected_file)
        song_data = data[0]
        song_name = current_selected_file.name.replace(".json", "")
        
        # Hiển thị tên bài hát đang chọn ngoài màn hình chính
        st.subheader(f"Bài hát đang phát: {song_name}")
        ...
        # =========================================================================
        # XẾP DÒNG NHẠC VÀO TRANG GIẤY CHUẨN (8 DÒNG/TRANG)
        # =========================================================================
        display_html = ""
        lines_per_page = 8 
        pages_list = []
        ...
        # =========================================================================
        # XỬ LÝ TRUYỀN TOÀN BỘ TRANG IN BẰNG PYTHON & MÃ HÓA JSON
        # =========================================================================
